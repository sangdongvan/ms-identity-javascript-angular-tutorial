...
export const b2cPolicies = {
  ...
  authorities: {
    signUpSignIn: {
      authority: 'https://msidentity104.b2clogin.com/msidentity104.onmicrosoft.com/B2C_1_SignUpSignIn',
    },
    resetPassword: {
      authority: 'https://msidentity104.b2clogin.com/msidentity104.onmicrosoft.com/B2C_1_ResetPassword',
    },
    editProfile: {
      authority: 'https://msidentity104.b2clogin.com/msidentity104.onmicrosoft.com/B2C_1_EditProfile',
    },
  },
  authorityDomain: 'msidentity104.b2clogin.com',
};
...
export const msalConfig: Configuration = {
  auth: {
    clientId: 'b565517c-2d83-42d9-a6eb-c57a3f47e0be', // This is the ONLY mandatory field that you need to supply.
